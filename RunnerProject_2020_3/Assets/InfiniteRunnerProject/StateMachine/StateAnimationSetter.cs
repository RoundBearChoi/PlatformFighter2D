...
namespace RB
{
    ...
    public class StateAnimationSetter : ScriptableObject
    {
        ...
        public void State_OldCity_Platforms_Idle(SpriteAnimationSpec spec)
        {
        ...
        public void State_OldCity_Pillars_Idle(SpriteAnimationSpec spec)
        {
            OldCity_Pillars_DefaultState.animationSpec = spec;
        }
        ...
        public void State_LittleRed_Run(SpriteAnimationSpec spec)
        {
        ...
        public void State_LittleRed_Jump_Fall(SpriteAnimationSpec spec)
        {
            LittleRed_Jump_Fall.animationSpec = spec;
        }

        public void State_LittleRed_Attack_A(SpriteAnimationSpec spec)
        {
            LittleRed_Attack_A.animationSpec = spec;
        }
    }
}