...
namespace RB
{
    public class Swamp_FrontTrees_DefaultState : UnitState
    {
        ...
        public Swamp_FrontTrees_DefaultState(Unit unit)
        {
            ...
            _listStateComponents.Add(new HorizontalParallax(unit, unit.transform.position, BaseInitializer.current.swampParallaxSO.Swamp_FrontTrees_ParallaxPercentage));
