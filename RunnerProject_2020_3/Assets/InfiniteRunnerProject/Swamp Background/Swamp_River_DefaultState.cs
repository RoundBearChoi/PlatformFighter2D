...
namespace RB
{
    public class Swamp_River_DefaultState : UnitState
    {
        ...
        public Swamp_River_DefaultState(Unit unit)
        {
            ...
            _listStateComponents.Add(new HorizontalParallax(unit, unit.transform.position, GameInitializer.current.GetParallaxData(ParallaxDataType.SWAMP).Swamp_River_ParallaxPercentage));
