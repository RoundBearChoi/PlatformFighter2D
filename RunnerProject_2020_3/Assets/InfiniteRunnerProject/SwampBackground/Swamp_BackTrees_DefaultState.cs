...
namespace RB
{
    public class Swamp_BackTrees_DefaultState : State
    {
        ...
        public Swamp_BackTrees_DefaultState(Unit unit)
        {
            ...
            _listStateComponents.Add(new ParallaxBackground(unit, CameraController.gameCam.gameObject, StaticRefs.swampSpriteData.Swamp_BackTrees_ParallaxPercentage));
        }
