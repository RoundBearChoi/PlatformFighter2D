...
namespace RB
{
    public class Swamp_FrontTrees_DefaultState : State
    {
        ...
        public Swamp_FrontTrees_DefaultState(Unit unit)
        {
            ...
            _listStateComponents.Add(new HorizontalParallax(unit, 0f, CameraController.gameCam.gameObject, StaticRefs.swampSpriteData.Swamp_FrontTrees_ParallaxPercentage));
        }
